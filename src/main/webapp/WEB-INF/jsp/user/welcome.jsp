...
<div class="jumbotron">
	<div class="container">
		<h1>Welcome ${name}!</h1>
		<p>This is an application which helps you to take note of your ToDos. You can add your ToDos to this app and after you completed it you can delete them. Click the button below to manage your ToDo's</p>
		<p><a class="btn btn-primary btn-lg" href="list-todos" role="button">My ToDos</a></p>
	</div>
</div>
